...
/**
 * @Title: ReConfigWordCountSocket
 * @Author lxisnotlcn
 * @Package org.apache.flink.streaming.examples.wordcount
 * @Date 2024/4/19 19:53
 * @description: 重配置本地IDEA测试
 */
public class ReConfigWordCountSocket {
	...
	public static void main(String[] args) throws Exception{
		...
		final String hostname = "172.19.205.68";
		final int port = 7777;
		text = env.socketTextStream(hostname, port, "\n");
		//DataStreamSource<String> text = env.addSource(new TiltSource());
		...
		SingleOutputStreamOperator<Tuple3<String, Integer, Long>> tuple2SingleOutputStreamOperator = text.flatMap(
			...
			}).setMaxParallelism(32).name("upStream");
...
//					}
			...
			}).setMaxParallelism(32).name("ReConfig");
