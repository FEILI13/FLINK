...
//			subpartitionBuffersCount = Arrays.copyOf(subpartitionBuffersCount, newNumSubpartitions);
//			subpartitionBufferRecyclers = Arrays.copyOf(subpartitionBufferRecyclers, newNumSubpartitions);
//			subpartitionBuffersCount = Arrays.copyOfRange(subpartitionBuffersCount, subpartitionBuffersCount.length - newNumSubpartitions, subpartitionBuffersCount.length);
//			subpartitionBufferRecyclers = Arrays.copyOfRange(subpartitionBufferRecyclers, subpartitionBufferRecyclers.length - newNumSubpartitions, subpartitionBufferRecyclers.length);
			subpartitionBuffersCount[0] = Integer.MIN_VALUE;// TODO cut the partition
