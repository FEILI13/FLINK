...
public class TaskManagerServices {
	...
	private static NetworkEnvironment createNetworkEnvironment(
		...
		int numDeterminantBuffersPerJob = 1000;
		DeltaEncodingStrategy deltaEncodingStrategy = DeltaEncodingStrategy.HIERARCHICAL;
		boolean enableDeltaSharingOptimizations = true;
